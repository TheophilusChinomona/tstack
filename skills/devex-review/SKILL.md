...
preamble-tier: 3
version: 1.0.0
description: Live developer experience audit. (tstack)
triggers:
  - live dx audit
...
\`./plan-skills/devex-skills/review/dx-hall-of-fame.md\`
...
```bash
eval "$( 2>/dev/null)"
 2>/dev/null | grep plan-devex-review || echo "NO_PRIOR_PLAN_REVIEW"
```
...
```bash
 '{"skill":"devex-review","timestamp":"TIMESTAMP","status":"STATUS","overall_score":N,"product_type":"TYPE","tthw_measured":"TTHW","dimensions_tested":N,"dimensions_inferred":N,"boomerang":"YES_OR_NO","commit":"COMMIT"}'
```
...
```bash
 '{"skill":"devex-review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
