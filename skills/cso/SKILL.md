...
preamble-tier: 2
version: 2.0.0
description: Chief Security Officer mode. (tstack)
allowed-tools:
  - Bash
  - Read
  - Grep
...
22. Skill files that are part of tstack itself (trusted source)
...
```bash
 '{"skill":"cso","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
