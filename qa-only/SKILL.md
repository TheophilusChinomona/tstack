...
3. Copy report template from `qa/templatesqa-report-template.md` to output dir
...
**Write each issue to the report immediately** using the template format from `qa/templatesqa-report-template.md`.
